/*
 *
 * Header file for Hugin API, version 9.7.
 *
 * Copyright (C) 1989-2025, Hugin Expert A/S. All Rights Reserved.
 *
 *
...
typedef void(*h_delete_handler_t)(void const*);
# ifndef _H_DEF
...
_H_DEF(h_status_t h_domain_set_em_concurrency_level,(h_domain_t,size_t));
_H_DEF(h_count_t h_domain_get_em_concurrency_level,(h_domain_t));
...
_H_DEF(h_status_t h_domain_fine_tune_nb_tables,(h_domain_t,h_node_t));
_H_DEF(h_status_t h_domain_set_nb_fine_tune_learning_rate,
(h_domain_t,h_double_t));
_H_DEF(h_double_t h_domain_get_nb_fine_tune_learning_rate,(h_domain_t));
_H_DEF(h_status_t h_domain_set_nb_fine_tune_iterations_limit,
(h_domain_t,size_t));
_H_DEF(h_count_t h_domain_get_nb_fine_tune_iterations_limit,(h_domain_t));
...
_H_DEF(h_status_t h_node_compute_class_explanation_data,
(h_node_t,size_t,h_node_t,size_t,size_t));
...
_H_DEF(h_boolean_t h_ds_row_is_empty,(h_data_set_t,size_t));
...
_H_DEF(h_double_t*h_ds_compute_iem_intervals,
(h_data_set_t,size_t,size_t,size_t*));
...
_H_DEF(void network_set_swift_object,
(h_domain_t,void*,h_delete_handler_t));
_H_DEF(void*network_get_swift_object,(h_domain_t));
_H_DEF(h_status_t delete_network,(h_domain_t));
_H_DEF(void node_set_swift_object,(h_node_t,void*,h_delete_handler_t));
_H_DEF(void*node_get_swift_object,(h_node_t));
_H_DEF(void cc_set_swift_object,(h_class_collection_t,void*));
_H_DEF(void*cc_get_swift_object,(h_class_collection_t));
_H_DEF(void table_set_swift_object,(h_table_t,void*,h_delete_handler_t));
_H_DEF(void*table_get_swift_object,(h_table_t));
_H_DEF(size_t table_get_d_rank,(h_table_t));
_H_DEF(h_number_t table_get_data_item,(h_table_t,size_t));
_H_DEF(h_status_t table_set_data_item,(h_table_t,size_t,h_number_t));
_H_DEF(void table_copy_data,(h_table_t,h_number_t const*,size_t,size_t));
_H_DEF(void model_set_swift_object,(h_model_t,void*,h_delete_handler_t));
_H_DEF(void*model_get_swift_object,(h_model_t));
_H_DEF(void clique_set_swift_object,
(h_clique_t,void*,h_delete_handler_t));
_H_DEF(void*clique_get_swift_object,(h_clique_t));
_H_DEF(void jt_set_swift_object,
(h_junction_tree_t,void*,h_delete_handler_t));
_H_DEF(void*jt_get_swift_object,(h_junction_tree_t));
_H_DEF(size_t domain_get_number_of_map_nodes,(h_domain_t));
_H_DEF(h_status_t domain_set_log_file,(h_domain_t,h_string_t,h_boolean_t));
_H_DEF(h_data_set_t s_csv_parse_data_set_from_file,
(h_string_t,h_string_t,h_error_handler_t,void*));
_H_DEF(h_data_set_t s_csv_parse_data_set_from_string,
(h_string_t,h_string_t,h_error_handler_t,void*));
_H_DEF(h_status_t s_ds_save,(h_data_set_t,h_string_t,h_string_t));
_H_DEF(h_string_t s_ds_to_csv_string,(h_data_set_t,h_string_t));
_H_DEF(h_status_t s_node_reorder_states,(h_node_t,char*const*));
_H_DEF(h_boolean_t cg_node_has_entered_value,(h_node_t));
_H_DEF(h_boolean_t cg_node_has_propagated_value,(h_node_t));
_H_DEF(void const*s_create_license,
(h_string_t,h_string_t,h_string_t,h_string_t,
long,long,long,long));
_H_DEF(void s_free_license,(void const*));
_H_DEF(h_domain_t s_new_domain,(const void*));
_H_DEF(h_class_collection_t s_new_cc,(void const*));
_H_DEF(h_domain_t s_net_parse_domain_from_file,
(h_string_t,h_error_handler_t,void*,void const*));
_H_DEF(h_domain_t s_net_parse_domain_from_string,
(h_string_t,h_error_handler_t,void*,void const*));
_H_DEF(h_domain_t s_kb_load_domain,(h_string_t,h_string_t,void const*));
_H_DEF(h_class_collection_t s_kb_load_class_collection,
(h_string_t,h_string_t,void const*));
_H_DEF(h_status_t s_cc_parse_classes_from_file,
(h_class_collection_t,h_string_t,h_error_handler_t,void*));
_H_DEF(h_status_t s_cc_parse_classes_from_string,
(h_class_collection_t,h_string_t,h_error_handler_t,void*));
_H_DEF(h_status_t s_model_set_expression_from_string,
(h_model_t,size_t,h_string_t));
_H_DEF(void s_free_string,(h_string_t));
# undef _H_DEF
# ifdef __cplusplus
}
# endif
